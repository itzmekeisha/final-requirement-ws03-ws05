...
<div class="dashboard-container">
    ...
    <div class="header">
        ...
        <a href="#" onclick="confirmLogout()" style="color: #ef4444; text-decoration: none;">
    ...
    <div class="toolbar">
        ...
        <a href="add_item_request.php" class="btn-request">
            <i class="fa-solid fa-plus"></i> Request Item
        </a>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <span class="status-pill"
                              style="background: <?php echo ($req['status'] == 'approved' ? '#065f46' : '#92400e'); ?>;">
